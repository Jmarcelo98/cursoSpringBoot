...
public class DBService {
	...
	public void instaciarTesteBancoDeDados() throws ParseException {
...
//		CLIENTES
		Cliente cli1 = new Cliente(null, "Maria Silva", "joaomarcelo588@gmail.com", "36378912377",
				TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente(null, "Ana Costa", "steamjoaomarcelo1@gmail.com", "49128620020",
				TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("995626823", "968395024"));
